...
public class genggaiemailActivity extends AppCompatActivity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_genggaiemail);
        ...
        fanhui.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    //finish();
                    Intent i = new Intent(genggaiemailActivity.this, zhanghuguanliActivity.class);
                    startActivity(i);
        ...
        queding.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(genggaiemailActivity.this, zhanghuguanliActivity.class);
                //启动
