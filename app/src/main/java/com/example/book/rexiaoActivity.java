...
public class rexiaoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_rexiao);


        Toolbar toolbar=(Toolbar)findViewById(R.id.rexiaotoolbar);
        toolbar.setTitle("");
        toolbar.inflateMenu(R.menu.mune_bookxinxi);
        setSupportActionBar(toolbar);
        progressDialog= new ProgressDialog(rexiaoActivity.this);
        ...
        //返回按钮事件**************
        ImageButton rexiaofanhui = (ImageButton) findViewById(R.id.rexiaofanhui);
        rexiaofanhui.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                } else if (event.getAction() == MotionEvent.ACTION_UP) {
                    //finish();
                    Intent i = new Intent(rexiaoActivity.this, gerenzhongxinActivity.class);
                    startActivity(i);
            ...
            public void done(BmobQueryResult<Book> result, BmobException e) {
                if(e ==null)
                {
                    ...
                    if(list!=null && list.size()>0)
                    {
                        ...
                        rexiaoAdapter adapter = new rexiaoAdapter(rexiaoActivity.this,R.layout.listrexiao,booklist);
                        ListView listView = (ListView)findViewById(R.id.rexiaolistview);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.Bookxinxizhuye:
                Toast.makeText(rexiaoActivity.this, "收藏", Toast.LENGTH_SHORT).show();
                break;
            case R.id.Bookxinxigeren:
                Toast.makeText(rexiaoActivity.this, "分享", Toast.LENGTH_SHORT).show();
                break;
            case R.id.Bookxinximydianpu:
                Toast.makeText(rexiaoActivity.this, "分享", Toast.LENGTH_SHORT).show();
                break;
            case R.id.Bookxinxigouwuche:
                Toast.makeText(rexiaoActivity.this, "字号", Toast.LENGTH_SHORT).show();
                break;
            case R.id.Bookxinxidingdan:
                Toast.makeText(rexiaoActivity.this, "模式", Toast.LENGTH_SHORT).show();
                break;
        }
