...
public class genggainameActivity extends AppCompatActivity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_genggainame);
        ...
        fanhui.setOnTouchListener(new View.OnTouchListener() {
            public boolean onTouch(View v, MotionEvent event) {
                if (event.getAction() == MotionEvent.ACTION_DOWN) {
                    ...
                    //finish();
                    Intent i = new Intent(genggainameActivity.this, zhanghuguanliActivity.class);
                    startActivity(i);
        ...
        queding.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                Intent intent = new Intent(genggainameActivity.this, zhanghuguanliActivity.class);
                //启动
